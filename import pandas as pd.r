...
print('mean,median,mode,stdev of height is {},{},{},{}'.format(height_mean,height_median,height_mode,height_std_deviation))
print('mean,median,mode,stdev of weight is {},{},{},{}'.format(weight_mean,weight_median,weight_mode,weight_std_deviation))
